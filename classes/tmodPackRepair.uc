/*
Time Stamp: 26-02-15 12:07:28
*/

class tmodPackRepair extends Gameplay.RepairPack implements IRepairClient config(tribesmodSettings); //contains elements from Lords mod


var config float activePeriod                     "How frequently the active repair effect is applied in seconds";
var config float passivePeriod                    "How frequently the passive repair effect is applied in seconds";
var config float radius                           "The radius within which repair effects will be applied to friendly players and objects";
var config float activeHealthPerPeriod            "The health per activePeriod to restore to friendly players and objects when active";
var config float activeExtraSelfHealthPerPeriod   "The extra health per activePeriod to restore to user when active";
var config float passiveHealthPerPeriod           "The health per passivePeriod to restore to user when the pack is worn";
var config float accumulationScale                "How much this pack's active effect stacks with the active effect of other packs";
var config string socketFrontUp;
var config string socketFrontDown;
var config string socketBackUp;
var config string socketBackDown;
